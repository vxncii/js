...
const aluno1 = new Aluno("Luan", 0, [10.0, 7.5, 8.0, 9.0]);
const aluno2 = new Aluno("Pedro", 2, [5.0, 4.5, 3.0, 6.0]);
const aluno3 = new Aluno("Carlos", 4, [10.0, 6.5, 5.0, 9.0]);
const aluno4 = new Aluno("Ruan", 9, [7.0, 8.5, 8.0, 7.5]);
const aluno5 = new Aluno("Alberto", 8, [9.0, 7.3, 6.7, 5.2]);
const aluno6 = new Aluno("Igor", 10, [10.0, 7.0, 8.2, 6.0]);
const aluno7 = new Aluno("Fernando", 0, [4.0, 3.5, 2.4, 5.0]);
const aluno8 = new Aluno("Chico", 2, [9.0, 7.5, 8.5, 9.0]);
const aluno9 = new Aluno("Matheus", 4, [3.0, 4.0, 5.4, 3.2]);
const aluno10 = new Aluno("Adryan", 6, [10.0, 7.0, 8.5, 9.0]);
...
// console.log(curso1.buscadorEstudante("Luan"));
// curso1.avaliadorEstudante("Luan");
// curso1.avaliadorEstudante("Ruan");
// curso1.avaliadorEstudante("Matheus");
